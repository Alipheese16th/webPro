...
CREATE TABLE MOVIE(
  movieID VARCHAR2(1000) PRIMARY KEY,
  originalTITLE VARCHAR2(1000) NOT NULL,
  movieTITLE VARCHAR2(1000) NOT NULL,
...
CREATE TABLE TAG(
  movieID VARCHAR2(1000) REFERENCES MOVIE(movieID),
  TAG VARCHAR2(30),
  CONSTRAINT TAG_PK PRIMARY KEY(movieID,TAG)
);
CREATE TABLE TRAILER(
  movieID VARCHAR2(1000) REFERENCES MOVIE(movieID),
  TRAILERNAME VARCHAR2(100),
  TRAILERURL VARCHAR2(1000),
  CONSTRAINT TRAILER_PK PRIMARY KEY(movieID,TRAILERNAME)
);
...
CREATE TABLE MOVIE_PERSON(
  mpNO NUMBER(5) PRIMARY KEY,
  movieID VARCHAR2(1000),
...
CREATE SEQUENCE MP_SEQ NOCACHE NOCYCLE;
