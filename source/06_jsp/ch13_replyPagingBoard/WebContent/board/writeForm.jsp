...
<body>
	<%
		...
		if(request.getParameter("num")!=null){
			...
			System.out.println("writeForm에서 넘어온 원글의 ref : "+ref);
			System.out.println("writeForm에서 넘어온 원글의 re_step : "+re_step);
			System.out.println("writeForm에서 넘어온 원글의 re_indent : "+re_indent);
		}
	%>
			...
			<tr>
				...
				<td>
					<input type="text" name="subject" required="required" 
								value="<%
									if(dto.getSubject()!=null) out.print("답 : "+dto.getSubject());
								%>">
				</td>
			</tr>
			<tr>
