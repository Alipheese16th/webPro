...
<body>
	...
	<%
		...
		if(result==MemberDao.MEMBER_EXISTENT){
			...
			MemberDto dto = new MemberDto(id,"111","갓길동",null,null,
		...
		dto = new MemberDto("aaa","999","나몰라",null,null,
				null,null,"north@korea.com",null,"북한",null);
		result = dao.modifyMember(dto);
		if(result == MemberDao.SUCCESS){
			out.println("수정완료");
			out.println("db의 수정된 데이터 : "+dao.getMember(dto.getId()));
		}else{
