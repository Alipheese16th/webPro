	...
	<%
		...
		try{
			...
			while(paramNames.hasMoreElements()){
				...
				originalFilename = mRequest.getOriginalFileName(param); // 파라미터에 첨부한 오리지날 파일이름
		...
		try{
			...
			if(serverFile.exists()){
				...
				os = new FileOutputStream("D:/webPro/source/06_jsp/ch14_fileUp/WebContent/fileUpFolder/"+filename);  // 소스 폴더로 복사될 파일
				...
				System.out.println("서버에 있는 파일을 소스폴더로 복사 완료");
			}
		}catch(Exception e){
			System.out.println(e.getMessage());
		}finally{
