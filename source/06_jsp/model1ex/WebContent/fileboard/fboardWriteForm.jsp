...
<body>
	...
	<div id="content_form" style="padding-top:40px;">
	<%
		// fboardWriteForm.jsp => 원글쓰기
		// 					fsubject, fcontent, ffilename, fpw, (cid는 로그인사용자로부터:세션)
		//					fref, fre_step, fre_level (0으로 넘김)
		// fboardWriteForm.jsp?fnum=1&pageNum=9 => 1번글에 대한 답글쓰기
		// 					fsubject, fcontent, ffilename, fpw, (cid는 세션)
		//					fref, fre_step, fre_level (원글에서 가져온 데이터)
		...
		if(request.getParameter("fnum")!=null){ // fnum번 글의 답글 쓰러 왔음
			...
			fDto = fDao.getBoard(fnum);   // 원글의 대한 정보 (fref, fre_step, fre_level)
		}
	%>
