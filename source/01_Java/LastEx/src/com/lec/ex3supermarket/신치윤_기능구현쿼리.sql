...
UPDATE CUSTOMER SET CAMOUNT = CAMOUNT + 100000, CPOINT = CPOINT + 100000*0.05 WHERE CID = 1;
...
UPDATE CUSTOMER SET CAMOUNT = CAMOUNT + 100000, 
                    CPOINT = CPOINT + 100000*0.05,
                    GNO = (SELECT G.GNO
                                FROM CUSTOMER, GRADE G
                                WHERE CAMOUNT+100000 BETWEEN LAMOUNT AND HIAMOUNT AND CID = 1)
    WHERE CID = 1;
