...
public class Ex01_HashMap {
	public static void main(String[] args) {
		...
		hashMap.put(11, "str11");	//key는 유일한 값 (중복불가)	//key값을 똑같이하면 데이터가 수정이된다.
		hashMap.put(12, "str11");	
		hashMap.put(20, "str20");
		hashMap.put(33, "str33");
		
		System.out.println(11+"key값의 데이터는 "+hashMap.get(11));
		System.out.println(hashMap);	//순서가 없다
		hashMap.remove(12);	//remove 는 key값으로만 이용
