<template>
  <div>
    ...
    <popup ref="edtpop" mkey1="wknstourchktgtmgntchdtledt1" mkey2="wknstourchktgtmgntchdtledt2" @close="popClose" />
    <rgnslct ref="edtpop2" :iswkpl="false" :wkplid="frmData.wkpl_id" mkey="wknstourchktgtmgntchdtledt1" @close="popLocClose" />
  </div>
</template>
