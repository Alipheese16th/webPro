        ...
        <v-col cols="10">
          <v-container>
            <v-row>
              ...
              <v-col cols="3">
                <v-select ref="cmpy_cd" v-model="schData.cmpy_cd" item-text="cd_nm" item-value="cd" :items="codes.CO00000009"></v-select>
              </v-col>
              <v-col cols="1">
                <!--사업장명-->
              ...
              <v-col cols="3">
                <v-text-field ref="wkpl_nm" v-model="schData.wkpl_nm" :placeholder="$t('LB00000033')" @keyup.enter="select"></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-col>
