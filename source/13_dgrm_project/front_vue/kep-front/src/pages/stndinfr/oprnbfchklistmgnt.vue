<template>
  <div>
    <div class="location">
      <span>Home > 기준정보 > 작업 전 점검 체크리스트 관리</span>
    </div>
    <div class="work_title">
      <h2>작업 전 점검 체크리스트 관리</h2>
    </div>
      ...
      <v-row>
        ...
        <v-col cols="2">
          <div class="sch_btn">
            ...
            <v-btn color="primary" depressed height="36" @click="selectOprnBfChkList">검색</v-btn>
          </div>
        </v-col>
      </v-row>
    </div>
    ...
    <div class="realgrid_container">
      <div class="sub_title"><h3>작업 전 점검 체크리스트 목록</h3></div>
...
export default {
  ...
  data() {
    return {
      ...
      codeid: ['ST00000007', 'ST00000008', 'ST00000009'],
      codes: {
        ST00000007: [{ cd: '', cd_nm: '' }],
        ST00000008: [{ cd: '', cd_nm: '' }],
        ST00000009: [{ cd: '', cd_nm: '' }],
  ...
  mounted() {
    this.$axios
      ...
      .then((res) => {
        ...
        this.selST00000008.cd.push('')
        this.selST00000008.cd_nm.push('SELECT')
        ...
        res.ST00000008.forEach((i) => {
          this.selST00000008.cd.push(i.cd)
          this.selST00000008.cd_nm.push(i.cd_nm)
        })
        ...
        this.codes.ST00000007.unshift({ cd: '', cd_nm: 'ALL' })
        this.codes.ST00000008.unshift({ cd: '', cd_nm: 'ALL' })
        ...
        const columns = [
          ...
          },
          {
            ...
            width: '100',
            lookupDisplay: true,
            values: this.selST00000008.cd,
            labels: this.selST00000008.cd_nm,
            editor: {
              type: 'dropdown',
              domainOnly: true,
              textReadOnly: false,
  ...
  methods: {
    ...
    async selectOprnBfChkList() {
      this.schData.chec_gb = 'CHK001' // 작업 전 점검 구분 코드
