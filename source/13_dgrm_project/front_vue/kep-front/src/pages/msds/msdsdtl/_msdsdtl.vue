<template>
  <div>
    <div class="location">
      <!-- MSDS 상세 -->
      <span>Home > MSDS > {{ $t('LB00000265') }}</span>
    </div>
    <!-- MSDS 상세 -->
    <div class="work_title">
      <!-- eslint-disable -->
      <h2>{{ $t('LB00000265') }} <span v-html="titleHtml" class="work_title2"></span></h2>
    </div>
        ...
        <v-col cols="12">
          <v-container>
            ...
            <v-row>
              ...
              <v-col cols="7">
                <div class="label_con">{{ frmData.msds.impt_yn }}</div>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="1">
...
export default {
  ...
  created() {
    // 파라미터 조회
    this.mtrlNo = this.$route.params.msdsdtl
      ...
      this.$router.push({
        ...
        params: {
          schData: {
            ...
            sbst_yn: this.tmpSchData.sbst_yn,
          },
        },
      })
    },
