  ...
  mounted() {
    ...
    this.$axios
      ...
      .then((res) => {
        ...
        if (this.$route.params.riskevaltgtdtlwklup) {
          this.frmData.dgsn_apal_id = this.$route.params.riskevaltgtdtlwklup
          this.select()
        }
      })
      .catch((err) => {
    ...
    pre() {
      this.$router.push({
        ...
        params: {
          ...
          riskevalbasiclup: this.frmData.dgsn_apal_id,
        },
      })
    },
    next() {
      this.$router.push({
        ...
        params: {
          schData: this.schData,
          riskevalharmdngftlup: this.frmData.dgsn_apal_id,
        },
      })
    },
    goStep(step) {
