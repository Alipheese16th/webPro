          ...
          <v-card flat>
            <div class="realgrid_container">
              ...
              <div class="container_filelist" style="max-height: 100px">
                <table>
                  <div v-if="true">
                    <file-upload ref="upload2" :multiple="true" @onDrop="chkReqFile()" />
                  </div>
                </table>
                <div class="group_padd"></div>
              </div>
          ...
          <v-card flat>
            <div class="realgrid_container">
              ...
              <div class="container_filelist" style="max-height: 100px">
                <table>
                  <div v-if="true">
                    <file-upload ref="upload3" :multiple="true" @onDrop="chkReqFile()" />
                  </div>
                </table>
                <div class="group_padd"></div>
              </div>
...
export default {
  ...
  created() {
    ...
    if (this.$route.params.cstcmpnmgntdtllup !== null && this.$route.params.cstcmpnmgntdtllup !== undefined) {
      this.schData.key_id = this.$route.params.cstcmpnmgntdtllup
    }
    // 이전 검색 결과 저장
