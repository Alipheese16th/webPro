...
export default {
      ...
      if (current.column === 'bbs_doc_ttl') {
        if (this.searchdatas.userApi) {
          this.$router.push({
            ...
            params: {
              faqedt: this.searchdatas.bbs_doc_no,
              schData: {
          ...
          this.$router.push({
            ...
            params: {
              faqlup: this.searchdatas.bbs_doc_no,
              schData: {
                bbs_doc_ttl: this.searchdatas.bbs_doc_ttl,
                bbs_doc_cntn: this.searchdatas.bbs_doc_cntn,
                doc_type_cd: this.searchdatas.doc_type_cd,
  ...
  methods: {
    ...
    async select() {
      ...
      const rows = await this.$axios.$get(`/api/v1/common/bbs/faqs`, { params: this.searchdatas })
