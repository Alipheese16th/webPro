package com.kist.portal.ch.rgltchk.mapper;
...
@Mapper
public interface RgltChkMapper {
	...
	public int insertRgltChkExceptionLang(Map<String, String> param);
	...
	public int updateMtrlMst(Map<String, String> param);
	...
	public int insertRgltChkExceptionCd(Map<String, String> param);
}
