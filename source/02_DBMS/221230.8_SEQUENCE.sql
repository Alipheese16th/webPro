...
CREATE SEQUENCE FRIEND_SEQ
    ...
    MAXVALUE 9999   -- 최대값
    MINVALUE 1      -- 최소값
    NOCACHE         -- 미리 시퀀스값을 만들어두기때문에 사용하지 않는다
    NOCYCLE;        -- 최대값 이후 다시 처음부터 회전하기때문에 안씀
    
SELECT FRIEND_SEQ.NEXTVAL FROM DUAL; -- 다음 순차번호
SELECT FRIEND_SEQ.CURRVAL FROM DUAL; -- 시퀀의 현재 값
DROP SEQUENCE FRIEND_SEQ;
...
INSERT INTO FRIEND (NUM,TEL,ADDRESS)
    VALUES (FRIEND_SQ.NEXTVAL,NULL,'010-9999-9999','서울시 마포구'); -- 에러 : NAME -NOT NULL
INSERT INTO FRIEND (NUM,NAME,TEL,ADDRESS)
    VALUES (FRIEND_SQ.NEXTVAL,'김길동','010-9999-9999','서울시 마포구');
INSERT INTO FRIEND (NUM,NAME,TEL,ADDRESS)
    VALUES (FRIEND_SQ.NEXTVAL,'신길동','010-9999-9999','서울시 영등포구'); -- 에러 : TELL -UNIQUE
INSERT INTO FRIEND (NUM,NAME,TEL,ADDRESS)
    VALUES (FRIEND_SQ.NEXTVAL,'진길동','010-8888-8888','수원시 영통구');
    -- ex. 초기값 101부터 최대값 999,999까지 1씩 증가하는 test_seq 시퀀스를 생성하고 
    --시퀀스 수를 사용하시오
